...
<header style="background: url('http://soyep.qiniudn.com/hader.jpg') center 0px repeat-x;background-size: cover;" id="header" class="header">
<div class="container-inner">
 <div class="relax-logo">
                    <a href="/">
                        <h1>
                                                        <span class="relax-mono"><?php bloginfo('name'); ?></span>
                                                        <span class="relax-bloger"><?php bloginfo('description'); ?></span>
                                                    </h1>
                    </a>
    </div>
</div>
