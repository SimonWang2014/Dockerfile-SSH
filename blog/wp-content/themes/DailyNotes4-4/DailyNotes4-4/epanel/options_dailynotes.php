...
function custom_colors_css(){
	...
	<style type="text/css">
		#body, .post div.url div div, .post div.url span { color: #<?php echo(get_option($shortname.'_color_mainfont')); ?>; }
		...
		.post div h2, .big_post h1, .main_post h1  { color: #<?php echo(get_option($shortname.'_color_headings')); ?>; }
		...
		.big_quote, .big_quote2 { color: #<?php echo(get_option($shortname.'_color_quote')); ?>; }
		.post_info, .post_info a, .post_info a:hover, .main_postinfo, .main_postinfo a, .main_postinfo a:hover { color: #<?php echo(get_option($shortname.'_color_postinfo')); ?>; }
	</style>
