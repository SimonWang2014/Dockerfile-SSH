...
function deel_copyright($content) {
	if( !is_page() ){
		...
		$content.= '<p>本文由 <a href="http://www.soyep.net" rel="next">周亦澄</a> 原创编译，转载请注明出处：<a href="'.get_permalink().'">'.get_permalink().'</a></p>';
	}
	return $content;
}
