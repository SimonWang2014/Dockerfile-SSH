...
function mytheme_add_admin() {
    ...
    if ( $_GET['page'] == basename(__FILE__) ) {
        ...
        if ( 'save' == $_REQUEST['action'] ) {
            ...
            header("Location: admin.php?page=Relax.php&saved=true");
...
<div class="wrap d_wrap">
    ...
    <h2><?php echo $themename; ?>设置
        ...
        <span class="d_themedesc">发布来源：<a href="http://www.skypod.pw/" target="_blank">然亦部落</a> &nbsp;&nbsp; <a href="http://skypod.pw/" target="_blank">访问<?php echo $themename; ?>主页</a></span><span style="font-size:16px;color: rgb(245, 99, 99);padding-left:20px;">觉得主题不错？支持一下我继续更新吧 -><a href="http://www.skypod.pw/about" target="_blank">捐赠</a></span>
